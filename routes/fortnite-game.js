            ...
            emergencynotices: [
                {
                    ...
                    title: 'Snow Alpha',
                    body: 'Snow Temporary Backend (Current) by Doener. SSL Bypass by me.',
                }
            ]
        },
    ...
    data.data.battleroyalenewsv2 = {
        news: {
            motds: [{
                ...
                videoMute: false,
                hidden: false,
                tabTitleOverride: 'Snow',
                _type: 'CommonUI Simple Message MOTD',
                title: 'Snow',
                body: 'Snow is not affiliated, associated, authorized, endorsed by, or in any way officially connected with Epic Games.',
                videoLoop: false,
                videoStreamingEnabled: false,
                sortingPriority: 0,
                id: 'StormNewsBRv2',
                ...
                videoFullscreen: false,
                spotlight: false,
                websiteURL: 'https://discord.gg/JqJDDBFUWn',
